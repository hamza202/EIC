jQuery(function($) {
   ...
   nextText: '<i class="fa fa-angle-right" aria-hidden="true"></i>',
    ...
    $("a.rev-btn[href*='#']").on("click", function(event) {
...
/////////////////////////////////////////////////////////////////
    ...
    $(".map-form-switcher .switcher-toggle").on('click', function(e){
        e.preventDefault();
        $('.b-map-form-holder .pix-b-contact-form').fadeToggle("300", "linear");
 ...
 */
    ...
    function sub_total_change(price, count){
        ...
        currency = $('.creatica_woo_currency').val();
        decimal_separator = $('.creatica_woo_decimal_separator').val();
        thousand_separator = $('.creatica_woo_thousand_separator').val();
        decimals = $('.creatica_woo_decimals').val();
        currency_pos = $('.creatica_woo_currency_pos').val();
    ...
    $('.shopping_cart-quantity input').on('change', function () {
        var currency = $('.creatica_woo_currency').val();
        var sufix = '';
        $.each($('.tawcvs-swatches span.selected'), function(){
            sufix = sufix+'_'+$(this).data('value');
        });
        var price = $('.creatica_woo_price'+sufix).val();
